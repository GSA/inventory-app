...
def test_transform_spatial_string():
...
def test_transform_spatial_bbox():
...
def test_transform_access_rights():
...
def test_transform_described_by():
    dataset = {
        "describedBy": "https://example.gov/schema.json",
        "describedByType": "application/schema+json"
    }
...
def test_transform_conforms_to():
...
def test_transform_landing_page():
    dataset = {
        "title": "Test Dataset",
        "landingPage": "https://example.gov/test-dataset"
    }
...
def test_transform_sub_organization_of():
    dataset = {
        "publisher": {
            "@type": "Organization",
            "name": "Sub-Agency",
